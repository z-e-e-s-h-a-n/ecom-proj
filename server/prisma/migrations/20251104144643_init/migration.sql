-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('admin', 'customer', 'productManager', 'inventoryManager', 'orderManager', 'shippingManager', 'supportAgent', 'marketingManager', 'financeManager');
...
-- CreateEnum
CREATE TYPE "ReturnExchangeStatus" AS ENUM ('pending', 'approved', 'rejected', 'awaiting_return', 'in_transit', 'received', 'refunded', 'exchanged');

-- CreateEnum
CREATE TYPE "ReturnShippingResponsibility" AS ENUM ('customer', 'seller');
...
-- CreateEnum
CREATE TYPE "EngagementType" AS ENUM ('cart', 'wishlist', 'compare', 'viewed');

-- CreateEnum
CREATE TYPE "ThemeType" AS ENUM ('dark', 'light', 'system');
...
-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('userSignup', 'userLogin', 'userPasswordReset', 'userPasswordChange', 'mfaEnabled', 'mfaDisabled', 'userProfileUpdated', 'roleAssigned', 'roleRevoked', 'orderCreated', 'orderCancelled', 'orderShipped', 'orderDelivered', 'orderRefunded', 'shipmentCreated', 'shipmentUpdated', 'shipmentCancelled', 'paymentCompleted', 'paymentFailed', 'paymentRefunded', 'productCreated', 'productUpdated', 'productDeleted', 'categoryCreated', 'categoryUpdated', 'categoryDeleted', 'reviewSubmitted', 'reviewApproved', 'reviewRejected', 'couponCreated', 'couponUpdated', 'couponDeleted', 'couponApplied', 'loyaltyPointsEarned', 'loyaltyPointsRedeemed', 'notificationSent', 'settingUpdated');
...
-- CreateTable
CREATE TABLE "ReturnExchangeVariant" (
    "id" TEXT NOT NULL,
    "returnExchangeId" TEXT NOT NULL,
    "variantId" TEXT NOT NULL,
    "quantity" INTEGER NOT NULL DEFAULT 1,

    CONSTRAINT "ReturnExchangeVariant_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "ReturnExchange" (
    ...
    "reason" TEXT,
    "status" "ReturnExchangeStatus" NOT NULL DEFAULT 'pending',
    "shippingResponsibility" "ReturnShippingResponsibility" NOT NULL DEFAULT 'customer',
...
CREATE TABLE "ShippingRate" (
    ...
    "minVolume" DECIMAL(10,2) NOT NULL,
...
CREATE TABLE "UserPreference" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "themeMode" "ThemeType" NOT NULL DEFAULT 'system',
...
CREATE TABLE "Setting" (
    ...
    "loyaltyPointValue" DECIMAL(10,2) NOT NULL DEFAULT 0.01,
...
-- CreateIndex
CREATE INDEX "Currency_country_idx" ON "Currency"("country");

-- CreateIndex
CREATE UNIQUE INDEX "Currency_code_key" ON "Currency"("code");

-- CreateIndex
CREATE UNIQUE INDEX "Currency_country_key" ON "Currency"("country");
...
-- CreateIndex
CREATE UNIQUE INDEX "VariantPricing_variantId_currencyId_key" ON "VariantPricing"("variantId", "currencyId");
...
-- CreateIndex
CREATE INDEX "ReturnExchange_orderId_idx" ON "ReturnExchange"("orderId");

-- CreateIndex
CREATE INDEX "ReturnExchange_refundId_idx" ON "ReturnExchange"("refundId");
...
-- CreateIndex
CREATE INDEX "ShippingRate_destinationCity_idx" ON "ShippingRate"("destinationCity");
...
-- CreateIndex
CREATE UNIQUE INDEX "Review_userId_productId_variantId_key" ON "Review"("userId", "productId", "variantId");
...
-- CreateIndex
CREATE INDEX "UserCoupon_userId_couponId_idx" ON "UserCoupon"("userId", "couponId");
...
-- AddForeignKey
ALTER TABLE "VariantWeight" ADD CONSTRAINT "VariantWeight_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VariantDimensions" ADD CONSTRAINT "VariantDimensions_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VariantPricing" ADD CONSTRAINT "VariantPricing_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VariantPricing" ADD CONSTRAINT "VariantPricing_currencyId_fkey" FOREIGN KEY ("currencyId") REFERENCES "Currency"("id") ON DELETE NO ACTION ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_currencyId_fkey" FOREIGN KEY ("currencyId") REFERENCES "Currency"("id") ON DELETE NO ACTION ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ReturnExchangeItem" ADD CONSTRAINT "ReturnExchangeItem_returnExchangeId_fkey" FOREIGN KEY ("returnExchangeId") REFERENCES "ReturnExchange"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReturnExchangeItem" ADD CONSTRAINT "ReturnExchangeItem_orderItemId_fkey" FOREIGN KEY ("orderItemId") REFERENCES "OrderItem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReturnExchangeVariant" ADD CONSTRAINT "ReturnExchangeVariant_returnExchangeId_fkey" FOREIGN KEY ("returnExchangeId") REFERENCES "ReturnExchange"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReturnExchangeVariant" ADD CONSTRAINT "ReturnExchangeVariant_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReturnExchange" ADD CONSTRAINT "ReturnExchange_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReturnExchange" ADD CONSTRAINT "ReturnExchange_refundId_fkey" FOREIGN KEY ("refundId") REFERENCES "Refund"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReturnExchange" ADD CONSTRAINT "ReturnExchange_initiatedById_fkey" FOREIGN KEY ("initiatedById") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ReturnExchange" ADD CONSTRAINT "ReturnExchange_approvedById_fkey" FOREIGN KEY ("approvedById") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Shipment" ADD CONSTRAINT "Shipment_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Shipment" ADD CONSTRAINT "Shipment_rateId_fkey" FOREIGN KEY ("rateId") REFERENCES "ShippingRate"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ShippingRate" ADD CONSTRAINT "ShippingRate_currencyId_fkey" FOREIGN KEY ("currencyId") REFERENCES "Currency"("id") ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TaxRate" ADD CONSTRAINT "TaxRate_currencyId_fkey" FOREIGN KEY ("currencyId") REFERENCES "Currency"("id") ON DELETE NO ACTION ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProductEngagement" ADD CONSTRAINT "ProductEngagement_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProductEngagement" ADD CONSTRAINT "ProductEngagement_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProductEngagement" ADD CONSTRAINT "ProductEngagement_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE NO ACTION ON UPDATE CASCADE;
